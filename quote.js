...
let coloor = document.getElementById('buildtype');
...
function displayElvCalcResult(buildingType) {
    ...
    if (buildingType == "commercial") {
       ...
       // coloor.style.backgroundColor = "blue !important";
       ...
       // coloor.style.backgroundColor = "red  !important";
        displayCalcElv_input.value = calculatedElv;
    } else {
        calculatedElv = numElevators_input.value;
        displayCalcElv_input.value = calculatedElv;
       // coloor.style.backgroundColor = "purple !important";
    }
}
...
let card_color1 = document.getElementById('card-color1');
let card_color2 = document.getElementById('card-color2');
let card_color3 = document.getElementById('card-color3');
let card_color4 = document.getElementById('card-color4');
let spanColor1 = document.getElementById('spanColor1');
...
building_type.addEventListener("change", function () {
    let headers = [card_color1, card_color2, card_color3, card_color4];
    let spanColor = [spanColor1, spanColor2, spanColor3, spanColor4]
    for (let i = 0; i < headers.length; i++){
    if (building_type.value == "commercial") {
        headers[i].style.backgroundColor = "#0a65a0";
        for (let j = 0; j < spanColor.length; j++){
        spanColor[j].style.color = "#A94545";
        }
    } else if (building_type.value == "residential") {
        headers[i].style.backgroundColor = "#A94545";
        for (let j = 0; j < spanColor.length; j++){
            spanColor[j].style.color = "#0a65a0";
            }
    } else if (building_type.value == "industrial") {
        headers[i].style.backgroundColor = "#d6cece";
    }
}
});
